...
meshColour = (0.988,0.541,0.09, 1)#(0.86, 0.64, 0.27,1) #0.96, 0.58, 0.53, 1
...
z = ""
for i in y.split(","):
    print(str(int(i.replace(" ", ""))/255) +", ")
    z += str(round(int(i.replace(" ", ""))/255, 3))+","

print(z)


circleColour = (0.96, 0.38, 0.01, 1)
hexColour =(0.96, 0.38, 0.01, 1)
shortName = "JARVIS"
fullName = "Just • A • Rather • Very • Intelligent • System"
nameTextColour = (255, 162, 64)#(198, 123, 24)
fullNameTextColour = (255, 162, 64)#(198, 123, 24)
picture = 'Jarvis.png'
...
class Terrain(QtGui.QMainWindow):
    def __init__(self):
        ...
        self.window.setWindowTitle("J.A.R.V.I.S")
